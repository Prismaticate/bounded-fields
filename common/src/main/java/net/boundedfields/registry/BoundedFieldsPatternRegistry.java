...
import net.boundedfields.casting.patterns.math.OpSignum;
import net.boundedfields.casting.patterns.spells.OpCongrats;
...
public class BoundedFieldsPatternRegistry {
