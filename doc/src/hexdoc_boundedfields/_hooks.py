...
import hexdoc_boundedfields

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class BoundedFieldsPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return BoundedFieldsModPlugin(branch=branch)


class BoundedFieldsModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_boundedfields, "_templates"
